...
- Capacidade de um método se comportar de diferentes formas em classes diferentes.

### [Herdar atributos e sobrescrever métodos](https://www.typescriptlang.org/docs/handbook/classes.html#inheritance)
- Herdar características de outra classe e personalizar comportamentos.

---

## Interfaces
### [Documentação Oficial](https://www.typescriptlang.org/docs/handbook/interfaces.html)
- Define o tipo de objetos e funções/classes (moldes de tipagem para criar objetos).
